...
<head>
    ...
    <style>
        /* ======================================================
           GESTÃO - Estilos internos (podem ser movidos para gestao.css)
           ====================================================== */
        ...
        .card-gestor:hover {
            ...
            box-shadow: 0 10px 32px rgba(254,16,16,0.14);
        }
        ...
        .card-foto {
            ...
            border-radius: 50%;
            object-fit: cover;
            border: 4px solid #fe1010;
            margin: 28px auto 16px;
            display: block;
            background: #eee;
        }

        /* Placeholder de foto (avatar com inicial) */
        .card-avatar {
            width: 96px;
            height: 96px;
            border-radius: 50%;
            ...
            border: 4px solid #fe1010;
            margin: 28px auto 16px;
            box-shadow: 0 4px 14px rgba(254,16,16,0.25);
        }
